...
VALUES (1, 1, 1, 131, 126, '12/14/2019', '15:00PM', 149, '2', '0', 'W', 'L', 151),
 ...
 /*Inserting new matched detail */
 INSERT INTO `matches` (`row_id`, `match_id`, `tournament_id`, `club_1`, `club_2`, `matchDate`, `KickOffTime`, `venue`, `club_1_score`, `club_2_score`, `club_1_result`, `club_2_result`, `match_status`, `createdDate`, `createdBy`, `modifiedDate`, `modifiedBy`, `isDeleted`) 
 VALUES ('26', '26', '1', '135', '133', '2020-01-01', '11:30 AM', '149', '1', '2', 'L', 'W', '151', '2020-01-01', 'Admin', NULL, NULL, NULL), 
 ('27', '27', '1', '138', '137', '2020-01', '15:00 PM', '149', '2', '0', 'W', 'L', '151', '2020-01-02', 'Admin', NULL, NULL, NULL);

/*Inserting new matched detail */
 INSERT INTO `matches` (`row_id`, `match_id`, `tournament_id`, `club_1`, `club_2`, `matchDate`, `KickOffTime`, `venue`, `club_1_score`, `club_2_score`, `club_1_result`, `club_2_result`, `match_status`, `createdDate`, `createdBy`, `modifiedDate`, `modifiedBy`, `isDeleted`) VALUES ('28', '28', '1', '136', '125', '2020-01-01', '15:00:00.000000', '149', '1', '2', 'L', 'W', '151', '2020-01-02', 'Admin', NULL, NULL, NULL);